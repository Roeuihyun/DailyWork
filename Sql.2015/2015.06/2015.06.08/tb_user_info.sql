...
INSERT INTO `tb_user_info`(`USER_ID`,`GRP_ID`,`PASSWD`,`EMAIL`,`USER_NM`,`PHONE_NO`,`COMP_TEL`,`BASE_ADDR`,`DETAIL_ADDR`,`REG_DATE`,`REG_ID`,`MOD_DATE`,`MOD_ID`,`STAT_CD`,`COMP_ID`) VALUES ('rkddn222','A','b22333@','bb@brain.com','이강우','010-2045-5109','02-3325-5454','서울특별시 금천구 가산동 60','904호 브레인넷','2015-06-03','admin',null,null,'Y','COMP0002');
