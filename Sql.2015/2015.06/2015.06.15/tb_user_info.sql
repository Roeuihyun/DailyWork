...
INSERT INTO `tb_user_info`(`USER_ID`,`GRP_ID`,`PASSWD`,`EMAIL`,`USER_NM`,`PHONE_NO`,`COMP_TEL`,`BASE_ADDR`,`DETAIL_ADDR`,`REG_DATE`,`REG_ID`,`MOD_DATE`,`MOD_ID`,`STAT_CD`,`COMP_ID`) VALUES ('1234','A','1234!@#$a','hahahaha@email.com','11111111','010-666-3333','02-0002-9384','1111','1234','2015-06-10','admin','2015-06-11','admin','N','COMP0001');
...
INSERT INTO `tb_user_info`(`USER_ID`,`GRP_ID`,`PASSWD`,`EMAIL`,`USER_NM`,`PHONE_NO`,`COMP_TEL`,`BASE_ADDR`,`DETAIL_ADDR`,`REG_DATE`,`REG_ID`,`MOD_DATE`,`MOD_ID`,`STAT_CD`,`COMP_ID`) VALUES ('rkddn','A','1q2w12qw','msj@brain.co.kr','이강우','','02-3325-5454','서울특별시 금천구 가산동 60','904호 브레인넷','2015-06-03','admin',null,null,'Y','COMP0002');
INSERT INTO `tb_user_info`(`USER_ID`,`GRP_ID`,`PASSWD`,`EMAIL`,`USER_NM`,`PHONE_NO`,`COMP_TEL`,`BASE_ADDR`,`DETAIL_ADDR`,`REG_DATE`,`REG_ID`,`MOD_DATE`,`MOD_ID`,`STAT_CD`,`COMP_ID`) VALUES ('rkddn2','A','12qw1q2w','bb@brain.co.kr','이강우','','02-3325-5454','서울특별시 금천구 가산동 60','904호 브레인넷','2015-06-03','admin','2015-06-10','admin','Y','COMP0002');
