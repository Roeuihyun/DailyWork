...
INSERT INTO `tb_cmm_main`(`MAIN_CD`,`MAIN_NM`,`MAIN_NM_ENG`,`NOTE`,`SORT_KEY`,`REG_DATE`,`REG_ID`,`MOD_DATE`,`MOD_ID`,`STAT_CD`) VALUES ('C00000','그룹코드','Group_Code','그룹메인코드','1','2015-05-27','admin',null,null,'Y');
