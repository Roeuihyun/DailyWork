...
INSERT INTO `tb_menu_info`(`MENU_ID`,`MENU_NM`,`MENU_NM_ENG`,`MENU_DEPTH`,`HIRK_MENU_ID`,`SORT_KEY`,`TARGET_URL`,`MENU_TYPE`,`NOTE`,`REG_DATE`,`REG_ID`,`MOD_DATE`,`MOD_ID`,`STAT_CD`) VALUES ('G0100','사용자 관리',null,'2','G0000','1','/user/openUserMng.do','0',null,'2015-06-03','admin',null,null,'Y');
