...
INSERT INTO `tb_cmm_sub`(`SUB_CD`,`SUB_NM`,`SUB_NM_ENG`,`NOTE`,`SORT_KEY`,`REG_DATE`,`REG_ID`,`MOD_DATE`,`MOD_ID`,`STAT_CD`,`MAIN_CD`) VALUES ('A','관리자','Admin','그룹 관리자','1','2015-05-27','admin',null,null,'Y',null);
INSERT INTO `tb_cmm_sub`(`SUB_CD`,`SUB_NM`,`SUB_NM_ENG`,`NOTE`,`SORT_KEY`,`REG_DATE`,`REG_ID`,`MOD_DATE`,`MOD_ID`,`STAT_CD`,`MAIN_CD`) VALUES ('O','운영자','Operator','그룹 운영자','2','2015-05-27','admin',null,null,'Y',null);
