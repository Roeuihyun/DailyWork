...
public class Section020_01 {
	...
	public static void main(String[] args) {
		...
		//4.첫번째로 변환되는 비트를 옮긴다. 첫 번째 비트는 이진수나 그레이 코드에 관계없이 입력받은 자료를 그대로 옮기며, 실제 데이터는 입력받은 배열의 두 번째부터라는 것을 염두에 두고 생각한다.
		CONT[0] = INPUT[1];
		...
		String CONTOUT = new String(CONT,0,CONT.length);
		System.out.print(CONTOUT);
